...
type state_type is (start,drivingDistance,align,alignedDriving,timedDriving,moveUntil,rotate90,stop,rs_start,delay);

signal allowAcc,drivingDistance_far,drivingDistance_close,deltaSub,motorRight,motorLeft,deltaBiggerThan,alignedDriving_maxDistance,count,allowNs,moveUntil_Condition,rotate_until,rotate_moveCond1,rotate_moveCond2,countAcc,condition_rs,delayEnd,finishState : boolean;
signal current_state , next_state , afterDelay_state: state_type;
signal delta : std_logic_vector(20 downto 0);
signal kaki : std_LOGIC;
...
signal delayCount : std_logic_vector (31 downto 0);
...
process (clk,rst,delayCount)
BEGIN
	if rst = '1' then 
		delayCount <= (others  => '0');
	elsif clk'event AND clk = '1' then 
		if (delayCount < 25000000) then
